Mental Health Digital Twin App
1. Project Overview
This is a full-stack AI-powered mental health journaling application that helps users track their daily mood, stress levels, sleep patterns, and personal reflections. The system uses AI to generate personalized emotional insights and well-being recommendations based on user journal entries.

🚀 Features
📊 Daily mood tracking with emoji-based input system
😰 Stress level & 😴 sleep monitoring
📝 Personal journal notes for each entry
🤖 AI-generated emotional insights and recommendations (Groq LLM)
📈 Mood history tracking and pattern detection
⚡ Real-time analysis of mental well-being trends
